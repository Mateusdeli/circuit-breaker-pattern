### Simple application to simulate the circuit breaker design pattern in order to control failure requests making the application more resilient and scalable.
